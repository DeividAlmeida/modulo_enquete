...
<div class="totalpoll-question-choices-item totalpoll-question-choices-item-results totalpoll-question-choices-item-type-text" >
  ...
  <div class="totalpoll-buttons" >
    <button id="blablavoltar" onclick="blablavoltar()" type="submit" style="color: <?php echo $central['cor_conteudo'];?>; border-color: <?php echo $central['cor_da_borda']?>; background: <?php echo $central['cor_fundo'];?>; " class="totalpoll-button totalpoll-buttons-back">Voltar para questões </button> 
 </div>
</div>
 </div></div>
    </div></center>
